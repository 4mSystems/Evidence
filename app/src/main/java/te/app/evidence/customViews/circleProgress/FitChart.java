...
public class FitChart extends View {
    ...
    private void readAttributes(AttributeSet attrs) {
        ...
        valueStrokeColor = resources.getColor(R.color.colorPrimary);
        backStrokeColor = resources.getColor(R.color.medium_color);
        strokeSize = resources.getDimension(R.dimen.sp18);
        if (attrs != null) {
