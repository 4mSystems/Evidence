...
public class FragmentConfirmCodeBindingImpl extends FragmentConfirmCodeBinding implements te.app.evidence.generated.callback.OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x4L) != 0) {
            ...
            this.appCompatButtonNext.setOnClickListener(mCallback120);
            this.mboundView1.setOnClickListener(mCallback119);
            ...
            this.tvLoginForget.setOnClickListener(mCallback121);
        }
        if ((dirtyFlags & 0x5L) != 0) {
            // api target 1
