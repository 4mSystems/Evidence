...
import grand.app.akar.databinding.FragmentFavoritesBinding;
...
public class FavoritesFragment extends BaseFragment {
    ...
    private void setEvent() {
        ...
        viewModel.getMyFavoritesAdapter().getLiveDataAdapter().observe((LifecycleOwner) context, integer -> viewModel.removeFavorites(0, integer));
    }
