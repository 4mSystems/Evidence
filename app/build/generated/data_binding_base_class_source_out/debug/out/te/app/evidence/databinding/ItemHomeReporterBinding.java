...
public abstract class ItemHomeReporterBinding extends ViewDataBinding {
  @NonNull
  ...
  protected ItemHomeReporterBinding(Object _bindingComponent, View _root, int _localFieldCount,
      ...
      CustomTextViewMedium sessionDateText, CustomTextViewRegular sessionMonthValue, View v2,
      View v3, View v5, View v6, View v7, CustomTextViewRegular viewValue) {
  ...
  @NonNull
  public static ItemHomeReporterBinding inflate(@NonNull LayoutInflater inflater,
   ...
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.item_home_reporter, root, attachToRoot, component)
   */
  @NonNull
  @Deprecated
  public static ItemHomeReporterBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable ViewGroup root, boolean attachToRoot, @Nullable Object component) {
    return ViewDataBinding.<ItemHomeReporterBinding>inflateInternal(inflater, R.layout.item_home_reporter, root, attachToRoot, component);
  }
   ...
   * compilation fails for another reason.
   * https://issuetracker.google.com/issues/116541301
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.item_home_reporter, null, false, component)
   */
  @NonNull
  @Deprecated
  public static ItemHomeReporterBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable Object component) {
    return ViewDataBinding.<ItemHomeReporterBinding>inflateInternal(inflater, R.layout.item_home_reporter, null, false, component);
  }

  public static ItemHomeReporterBinding bind(@NonNull View view) {
   ...
   */
  @Deprecated
  public static ItemHomeReporterBinding bind(@NonNull View view, @Nullable Object component) {
    return (ItemHomeReporterBinding)bind(component, view, R.layout.item_home_reporter);
  }
}
