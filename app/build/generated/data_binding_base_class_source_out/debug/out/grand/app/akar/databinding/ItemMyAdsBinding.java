...
public abstract class ItemMyAdsBinding extends ViewDataBinding {
  ...
  @NonNull
  public static ItemMyAdsBinding inflate(@NonNull LayoutInflater inflater, @Nullable ViewGroup root,
   ...
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.item_my_ads, root, attachToRoot, component)
   */
  @NonNull
  @Deprecated
  public static ItemMyAdsBinding inflate(@NonNull LayoutInflater inflater, @Nullable ViewGroup root,
      boolean attachToRoot, @Nullable Object component) {
    return ViewDataBinding.<ItemMyAdsBinding>inflateInternal(inflater, R.layout.item_my_ads, root, attachToRoot, component);
  }
   ...
   * compilation fails for another reason.
   * https://issuetracker.google.com/issues/116541301
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.item_my_ads, null, false, component)
   */
  @NonNull
  @Deprecated
  public static ItemMyAdsBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable Object component) {
    return ViewDataBinding.<ItemMyAdsBinding>inflateInternal(inflater, R.layout.item_my_ads, null, false, component);
  }

  public static ItemMyAdsBinding bind(@NonNull View view) {
   ...
   */
  @Deprecated
  public static ItemMyAdsBinding bind(@NonNull View view, @Nullable Object component) {
    return (ItemMyAdsBinding)bind(component, view, R.layout.item_my_ads);
  }
}
