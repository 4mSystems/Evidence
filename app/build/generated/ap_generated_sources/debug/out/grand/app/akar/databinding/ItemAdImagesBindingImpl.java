...
public class ItemAdImagesBindingImpl extends ItemAdImagesBinding implements grand.app.akar.generated.callback.OnClickListener.Listener {
    ...
    private ItemAdImagesBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback54 = new grand.app.akar.generated.callback.OnClickListener(this, 2);
        mCallback53 = new grand.app.akar.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x8L) != 0) {
            ...
            this.close1.setOnClickListener(mCallback54);
            this.image1.setOnClickListener(mCallback53);
        }
        if ((dirtyFlags & 0xdL) != 0) {
            // api target 1
