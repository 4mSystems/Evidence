...
public class FragmentCaseClientsBindingImpl extends FragmentCaseClientsBinding implements te.app.evidence.generated.callback.OnClickListener.Listener {
    ...
    public FragmentCaseClientsBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }
    private FragmentCaseClientsBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewmodel == variableId) {
            setViewmodel((te.app.evidence.pages.cases.viewModels.CaseClientsViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewmodel(@Nullable te.app.evidence.pages.cases.viewModels.CaseClientsViewModel Viewmodel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 1 :
                return onChangeViewmodel((te.app.evidence.pages.cases.viewModels.CaseClientsViewModel) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewmodel(te.app.evidence.pages.cases.viewModels.CaseClientsViewModel Viewmodel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    protected void executeBindings() {
        ...
        te.app.evidence.pages.cases.viewModels.CaseClientsViewModel viewmodel = mViewmodel;
        ...
        if ((dirtyFlags & 0x8L) != 0) {
            ...
            this.mboundView3.setOnClickListener(mCallback29);
        }
        if ((dirtyFlags & 0xbL) != 0) {
            // api target 1
