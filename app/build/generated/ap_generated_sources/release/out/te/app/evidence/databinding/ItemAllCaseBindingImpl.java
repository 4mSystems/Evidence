...
public class ItemAllCaseBindingImpl extends ItemAllCaseBinding implements te.app.evidence.generated.callback.OnClickListener.Listener {
    ...
    private ItemAllCaseBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback140 = new te.app.evidence.generated.callback.OnClickListener(this, 1);
        mCallback141 = new te.app.evidence.generated.callback.OnClickListener(this, 2);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x4L) != 0) {
            ...
            this.delete.setOnClickListener(mCallback141);
            this.viewValue.setOnClickListener(mCallback140);
        }
        if ((dirtyFlags & 0x5L) != 0) {
            // api target 1
