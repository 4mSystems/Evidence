...
import grand.app.akar.databinding.FragmentAddStoreFormBinding;
...
public class AddWareHosueFormFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        FragmentAddWarehouseFormBinding binding = DataBindingUtil.inflate(inflater, R.layout.fragment_add_warehouse_form, container, false);
