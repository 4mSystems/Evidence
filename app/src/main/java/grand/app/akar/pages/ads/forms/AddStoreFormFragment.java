...
public class AddStoreFormFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        FragmentAddStoreFormBinding binding = DataBindingUtil.inflate(inflater, R.layout.fragment_add_store_form, container, false);
