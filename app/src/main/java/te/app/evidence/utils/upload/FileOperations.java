...
public class FileOperations {
        ...
        if (DocumentsContract.isDocumentUri(context, uri)) {
            ...
            // DownloadsProvider
                ...
                final Uri contentUri = ContentUris.withAppendedId(
                        Uri.parse(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).getPath()), Long.parseLong(id));
    ...
    private String fileToString(String selectedPath) {
        ...
        try {
            inputStream = new FileInputStream(selectedPath);
    ...
    public static void pickImage(final Context context, int requestCode) {
