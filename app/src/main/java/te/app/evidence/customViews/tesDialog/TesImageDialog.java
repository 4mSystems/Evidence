package te.app.evidence.customViews.tesDialog;
...
import te.app.evidence.databinding.LayoutTesBinding;
...
class TesDialog extends RelativeLayout {
    ...
    public void init() {
        ...
        layoutGrandBinding.imgGrandClose.setOnClickListener(v -> dialog.dismiss());
    }
}
