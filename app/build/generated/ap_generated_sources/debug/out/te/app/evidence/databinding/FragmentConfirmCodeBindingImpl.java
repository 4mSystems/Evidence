...
public class FragmentConfirmCodeBindingImpl extends FragmentConfirmCodeBinding implements te.app.evidence.generated.callback.OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x2L) != 0) {
            ...
            this.appCompatButtonNext.setOnClickListener(mCallback98);
            this.mboundView1.setOnClickListener(mCallback97);
            ...
            this.tvLoginForget.setOnClickListener(mCallback99);
        }
        if ((dirtyFlags & 0x3L) != 0) {
            // api target 1
