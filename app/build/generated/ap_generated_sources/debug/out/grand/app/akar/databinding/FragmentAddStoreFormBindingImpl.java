...
public class FragmentAddStoreFormBindingImpl extends FragmentAddStoreFormBinding implements grand.app.akar.generated.callback.OnClickListener.Listener {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tv_paths_count, 34);
        sViewsWithIds.put(R.id.v10, 35);
        ...
        sViewsWithIds.put(R.id.tv_garage, 52);
        sViewsWithIds.put(R.id.tv_furniture, 53);
        sViewsWithIds.put(R.id.v16, 54);
        sViewsWithIds.put(R.id.tv_services, 55);
        sViewsWithIds.put(R.id.v17, 56);
        sViewsWithIds.put(R.id.tv_building_desc, 57);
    }
    // views
    @NonNull
    ...
    private FragmentAddStoreFormBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback15 = new grand.app.akar.generated.callback.OnClickListener(this, 14);
        mCallback16 = new grand.app.akar.generated.callback.OnClickListener(this, 15);
        mCallback9 = new grand.app.akar.generated.callback.OnClickListener(this, 8);
        mCallback13 = new grand.app.akar.generated.callback.OnClickListener(this, 12);
        mCallback8 = new grand.app.akar.generated.callback.OnClickListener(this, 7);
        mCallback14 = new grand.app.akar.generated.callback.OnClickListener(this, 13);
        ...
        mCallback12 = new grand.app.akar.generated.callback.OnClickListener(this, 11);
        ...
        mCallback17 = new grand.app.akar.generated.callback.OnClickListener(this, 16);
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x8000L) != 0) {
            ...
            this.furnitureToggle.setOnClickListener(mCallback12);
            this.garageToggle.setOnClickListener(mCallback11);
            this.hospital.setOnClickListener(mCallback15);
            ...
            this.mosque.setOnClickListener(mCallback13);
            this.policeStation.setOnClickListener(mCallback16);
            this.school.setOnClickListener(mCallback14);
        }
        if ((dirtyFlags & 0x8030L) != 0) {
            // api target 1
