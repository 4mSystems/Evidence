...
public class FragmentAddWarehouseFormBindingImpl extends FragmentAddWarehouseFormBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tv_warehouse_size, 12);
        sViewsWithIds.put(R.id.input_warehouse_size, 13);
        sViewsWithIds.put(R.id.v5, 14);
        sViewsWithIds.put(R.id.tv_warehouse_high, 15);
        sViewsWithIds.put(R.id.input_warehouse_high, 16);
