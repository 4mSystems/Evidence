    ...
    private void setEvent() {
        viewModel.liveData.observe(((LifecycleOwner) context), (Observer<Object>) o -> {
            ...
            if (Constants.CASE_DETAILS.equals(((Mutable) o).message)) {
                ...
                MovementHelper.startActivityForResultWithBundle(context, new PassingObject(viewModel.getCaseDetails().getCaseData().getId()), getString(R.string.sessions), SessionsFragment.class.getName(), Constants.CLIENTS_CODE);
            }
