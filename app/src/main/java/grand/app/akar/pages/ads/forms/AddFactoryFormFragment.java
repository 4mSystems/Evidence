...
public class AddFactoryFormFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        FragmentAddFactoryFormBinding binding = DataBindingUtil.inflate(inflater, R.layout.fragment_add_factory_form, container, false);
