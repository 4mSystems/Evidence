...
public class LayoutNavigationDrawerBindingImpl extends LayoutNavigationDrawerBinding implements te.app.evidence.generated.callback.OnClickListener.Listener {
    ...
    private LayoutNavigationDrawerBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback106 = new te.app.evidence.generated.callback.OnClickListener(this, 3);
        mCallback118 = new te.app.evidence.generated.callback.OnClickListener(this, 15);
        mCallback104 = new te.app.evidence.generated.callback.OnClickListener(this, 1);
        mCallback116 = new te.app.evidence.generated.callback.OnClickListener(this, 13);
        mCallback114 = new te.app.evidence.generated.callback.OnClickListener(this, 11);
        mCallback112 = new te.app.evidence.generated.callback.OnClickListener(this, 9);
        mCallback110 = new te.app.evidence.generated.callback.OnClickListener(this, 7);
        mCallback108 = new te.app.evidence.generated.callback.OnClickListener(this, 5);
        mCallback117 = new te.app.evidence.generated.callback.OnClickListener(this, 14);
        mCallback107 = new te.app.evidence.generated.callback.OnClickListener(this, 4);
        mCallback115 = new te.app.evidence.generated.callback.OnClickListener(this, 12);
        mCallback105 = new te.app.evidence.generated.callback.OnClickListener(this, 2);
        mCallback113 = new te.app.evidence.generated.callback.OnClickListener(this, 10);
        mCallback111 = new te.app.evidence.generated.callback.OnClickListener(this, 8);
        mCallback109 = new te.app.evidence.generated.callback.OnClickListener(this, 6);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x2L) != 0) {
            ...
            this.addCase.setOnClickListener(mCallback109);
            this.mboundView10.setOnClickListener(mCallback113);
            this.mboundView11.setOnClickListener(mCallback114);
            this.mboundView12.setOnClickListener(mCallback115);
            this.mboundView13.setOnClickListener(mCallback116);
            this.mboundView14.setOnClickListener(mCallback117);
            this.mboundView15.setOnClickListener(mCallback118);
            this.mboundView3.setOnClickListener(mCallback106);
            this.mboundView4.setOnClickListener(mCallback107);
            this.mboundView5.setOnClickListener(mCallback108);
            this.mboundView8.setOnClickListener(mCallback111);
            this.mboundView9.setOnClickListener(mCallback112);
            this.searchCase.setOnClickListener(mCallback110);
            this.tvUserLogin.setOnClickListener(mCallback105);
            this.vvNavigationDrawerImage.setOnClickListener(mCallback104);
        }
        if ((dirtyFlags & 0x3L) != 0) {
            // api target 1
