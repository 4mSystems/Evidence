...
public class AkarLocationsMapFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        FragmentAkarLocationsMapBinding binding = DataBindingUtil.inflate(inflater, R.layout.fragment_akar_locations_map, container, false);
