...
public class ItemSessionBindingImpl extends ItemSessionBinding implements te.app.evidence.generated.callback.OnClickListener.Listener {
    ...
    private ItemSessionBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        mCallback60 = new te.app.evidence.generated.callback.OnClickListener(this, 4);
    ...
    protected void executeBindings() {
        ...
        boolean itemViewModelUserDataUserDataEqualsJavaLangStringAdminTextUtilsIsEmptyItemViewModelSessionItemInvetationNumBooleanFalse = false;
        int itemViewModelUserDataUserDataEqualsJavaLangStringAdminTextUtilsIsEmptyItemViewModelSessionItemInvetationNumBooleanFalseViewVISIBLEViewGONE = 0;
        ...
        if ((dirtyFlags & 0x7L) != 0) {
                ...
                // read itemViewModel.userData.userData.equals("admin") ? TextUtils.isEmpty(itemViewModel.sessionItem.invetation_num) : false
                itemViewModelUserDataUserDataEqualsJavaLangStringAdminTextUtilsIsEmptyItemViewModelSessionItemInvetationNumBooleanFalse = ((itemViewModelUserDataUserDataEqualsJavaLangStringAdmin) ? (textUtilsIsEmptyItemViewModelSessionItemInvetationNum) : (false));
            if((dirtyFlags & 0x7L) != 0) {
                if(itemViewModelUserDataUserDataEqualsJavaLangStringAdminTextUtilsIsEmptyItemViewModelSessionItemInvetationNumBooleanFalse) {
                        dirtyFlags |= 0x40L;
                }
                else {
                        dirtyFlags |= 0x20L;
                ...
                // read itemViewModel.userData.userData.equals("admin") ? TextUtils.isEmpty(itemViewModel.sessionItem.invetation_num) : false ? View.VISIBLE : View.GONE
                itemViewModelUserDataUserDataEqualsJavaLangStringAdminTextUtilsIsEmptyItemViewModelSessionItemInvetationNumBooleanFalseViewVISIBLEViewGONE = ((itemViewModelUserDataUserDataEqualsJavaLangStringAdminTextUtilsIsEmptyItemViewModelSessionItemInvetationNumBooleanFalse) ? (android.view.View.VISIBLE) : (android.view.View.GONE));
        }
        // batch finished
        if ((dirtyFlags & 0x4L) != 0) {
            ...
            this.viewValue.setOnClickListener(mCallback60);
        }
        if ((dirtyFlags & 0x7L) != 0) {
            // api target 1

            this.delete.setVisibility(itemViewModelUserDataUserDataEqualsJavaLangStringAdminTextUtilsIsEmptyItemViewModelSessionItemInvetationNumBooleanFalseViewVISIBLEViewGONE);
            this.edit.setVisibility(itemViewModelUserDataUserDataEqualsJavaLangStringAdminTextUtilsIsEmptyItemViewModelSessionItemInvetationNumBooleanFalseViewVISIBLEViewGONE);
    ...
    /* flag mapping
        ...
        flag 2 (0x3L): null
        flag 3 (0x4L): itemViewModel.userData.userData.equals("admin") ? TextUtils.isEmpty(itemViewModel.sessionItem.invetation_num) : false
        flag 4 (0x5L): itemViewModel.userData.userData.equals("admin") ? TextUtils.isEmpty(itemViewModel.sessionItem.invetation_num) : false
        flag 5 (0x6L): itemViewModel.userData.userData.equals("admin") ? TextUtils.isEmpty(itemViewModel.sessionItem.invetation_num) : false ? View.VISIBLE : View.GONE
        flag 6 (0x7L): itemViewModel.userData.userData.equals("admin") ? TextUtils.isEmpty(itemViewModel.sessionItem.invetation_num) : false ? View.VISIBLE : View.GONE
        ...
        flag 9 (0xaL): TextUtils.isEmpty(itemViewModel.sessionItem.invetation_num) ? View.VISIBLE : View.GONE
        flag 10 (0xbL): TextUtils.isEmpty(itemViewModel.sessionItem.invetation_num) ? View.VISIBLE : View.GONE
    flag mapping end*/
    //end
}