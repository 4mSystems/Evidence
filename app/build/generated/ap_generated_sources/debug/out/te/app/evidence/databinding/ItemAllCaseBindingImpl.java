...
public class ItemAllCaseBindingImpl extends ItemAllCaseBinding implements te.app.evidence.generated.callback.OnClickListener.Listener {
    ...
    private ItemAllCaseBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback150 = new te.app.evidence.generated.callback.OnClickListener(this, 1);
        mCallback151 = new te.app.evidence.generated.callback.OnClickListener(this, 2);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x4L) != 0) {
            ...
            this.delete.setOnClickListener(mCallback151);
            this.viewValue.setOnClickListener(mCallback150);
        }
        if ((dirtyFlags & 0x5L) != 0) {
            // api target 1
