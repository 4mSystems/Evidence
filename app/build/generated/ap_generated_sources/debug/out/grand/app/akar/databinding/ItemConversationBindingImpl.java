...
public class ItemConversationBindingImpl extends ItemConversationBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.con_user_image, 1);
        sViewsWithIds.put(R.id.con_title, 2);
        sViewsWithIds.put(R.id.con_time, 3);
        sViewsWithIds.put(R.id.con_desc_text, 4);
        sViewsWithIds.put(R.id.br9, 5);
    }
    // views
    @NonNull
