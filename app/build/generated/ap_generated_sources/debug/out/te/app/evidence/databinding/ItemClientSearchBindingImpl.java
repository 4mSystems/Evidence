...
public class ItemClientSearchBindingImpl extends ItemClientSearchBinding implements te.app.evidence.generated.callback.OnCheckedChangeListener.Listener {
    ...
    // variables
    @Nullable
    private final android.widget.CompoundButton.OnCheckedChangeListener mCallback75;
    // values
    // listeners
    ...
    private ItemClientSearchBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback75 = new te.app.evidence.generated.callback.OnCheckedChangeListener(this, 1);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x4L) != 0) {
            ...
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setListeners(this.checkbox, mCallback75, (androidx.databinding.InverseBindingListener)null);
        }
    }
