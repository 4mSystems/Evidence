...
public class FragmentHomeBindingImpl extends FragmentHomeBinding implements te.app.evidence.generated.callback.OnClickListener.Listener {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.input_search, 15);
    }
    // views
    @NonNull
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x4L) != 0) {
            ...
            this.nextMohdareen.setOnClickListener(mCallback16);
            this.nextSessions.setOnClickListener(mCallback14);
            this.previousSessions.setOnClickListener(mCallback15);
        }
    }
