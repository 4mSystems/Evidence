...
public class ActivityBaseBindingImpl extends ActivityBaseBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.baseViewModel == variableId) {
            setBaseViewModel((grand.app.akar.base.BaseViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setBaseViewModel(@Nullable grand.app.akar.base.BaseViewModel BaseViewModel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeBaseViewModel((grand.app.akar.base.BaseViewModel) object, fieldId);
        }
        return false;
    }
    private boolean onChangeBaseViewModel(grand.app.akar.base.BaseViewModel BaseViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
