...
public class AddFlatFormFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        FragmentAddFlatFormBinding binding = DataBindingUtil.inflate(inflater, R.layout.fragment_add_flat_form, container, false);
