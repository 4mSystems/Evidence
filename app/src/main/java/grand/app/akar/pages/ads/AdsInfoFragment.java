...
import grand.app.akar.databinding.FragmentAboutBinding;
...
public class AdsInfoFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        FragmentAdsInfoBinding binding = DataBindingUtil.inflate(inflater, R.layout.fragment_ads_info, container, false);
