...
import grand.app.akar.databinding.FragmentAddFlatFormBinding;
import grand.app.akar.databinding.FragmentAddOfficeFormBinding;
...
public class AddOfficeFormFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        FragmentAddOfficeFormBinding binding = DataBindingUtil.inflate(inflater, R.layout.fragment_add_office_form, container, false);
